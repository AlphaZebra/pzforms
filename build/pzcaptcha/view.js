...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const loadRecaptchaScript = () => {
    const recaptchaBlocks = document.querySelectorAll(".wp-block-peakforms-pzcaptcha");
    ...
    if (!siteKey) {
      recaptchaBlocks.forEach(block => {
        block.innerHTML = '<p class="components-placeholder__error">reCAPTCHA site key is missing.</p>';
      });
      return;
    }
